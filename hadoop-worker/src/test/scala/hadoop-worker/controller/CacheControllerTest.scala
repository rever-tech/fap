package hadoop-worker.controller
...
import hadoop-worker.Server
import hadoop-worker.domain.UserID
import hadoop-worker.domain.thrift.{TUserID, TUserInfo}
import hadoop-worker.service.TUserCacheService.FinagledClient
